  ...
  return (
    <div style={styles.contentWrapper}>
      ...
      <div style={styles.headerBar}>
        <span style={styles.headerTitle}>Pension Schedule</span>
      ...
      <div style={styles.mainLayout}>
        <div style={styles.formArea}>
          ...
          <div style={styles.topRow}>
            ...
            <div style={styles.itemListContainer}>
              <div style={styles.itemHeader}>Pension Item Codes</div>
          ...
          <div style={styles.borderedSection}>
            <div style={styles.formGrid}>
              <div style={styles.column}>
                ...
                <div style={styles.fieldRow}><label style={styles.fLabel}>Amount</label><input type="text" style={styles.input} /></div>
                <div style={styles.fieldRow}><label style={styles.fLabel}>Authority</label><input type="text" style={styles.input} /></div>
              </div>

              <div style={styles.column}>
                <div style={styles.fieldRow}><label style={styles.fLabel}>Pension Type</label><input type="text" style={styles.input} /></div>
                <div style={styles.fieldRow}><label style={styles.fLabel}>Effective Date</label><input type="date" style={styles.input} /></div>
                <div style={styles.fieldRow}><label style={styles.fLabel}>End Date</label><input type="date" style={styles.input} /></div>
          ...
          <div style={styles.borderedSection}>
            <div style={styles.formGrid}>
              <div style={styles.column}>
                <div style={styles.fieldRow}><label style={styles.fLabel}>Bank Code</label><input type="text" style={styles.input} /></div>
                <div style={styles.fieldRow}><label style={styles.fLabel}>Branch Code</label><input type="text" style={styles.input} /></div>
        ...
        <div style={styles.buttonColumn}>
          ...
          <div style={styles.deleteGroup}>
            ...
            <label htmlFor="delPension" style={{ fontSize: '10px' }}>Delete Records</label>
          </div>
...
const styles = {
  ...
  listBox: { width: '300px', height: '80px', border: '1px solid #87ceeb', backgroundColor: '#fff' },

  borderedSection: { borderTop: '2px solid #87ceeb', paddingTop: '15px', marginTop: '15px' },
  formGrid: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' },
  column: { display: 'flex', flexDirection: 'column', gap: '8px' },
  fLabel: { fontSize: '11px', color: '#333', width: '100px' },
